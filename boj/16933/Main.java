...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(!q.isEmpty()){
            ...
            boolean day = cur[4] == 1 ? true : false;
            if(x == N - 1 && y == M - 1){
            ...
            for(int i = 0; i < 4; i++){
                ...
                v[nx][ny][breaks] = dist + 1; q.offer(new int[]{nx, ny, dist + 1, breaks, day ? 0 : 1});
            }
            if(breaks == K) continue;
            if(!day) {
                q.offer(new int[]{x, y, dist + 1, breaks, 1});
                continue;
            }
            // 부수고 이동
            for(int i = 0; i < 4; i++){
                ...
                v[nx][ny][breaks + 1] = dist + 1; q.offer(new int[]{nx, ny, dist + 1, breaks + 1, day ? 0 : 1});
            }
        }
